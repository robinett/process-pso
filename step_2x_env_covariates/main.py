...
def main():
    ...
    main_dir = (
        '/shared/pso/step_2x_env_covariates'
    )
    # directory where data is stored
    data_dir = '/shared/pso/step_2_env_covariates/data'
    # directory where catchment-cn forcing is stored
    catch_dir = '/shared/pso/step_2_env_covariates/data/catchment_cn_forcing'
    # directory where lai data is stored
    lai_dir = '/shared/pso/step_2_env_covariates/data/lai'
